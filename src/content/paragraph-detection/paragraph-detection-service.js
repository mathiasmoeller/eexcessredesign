(function () {
    ...
    function ParagraphDetectionService() {
        var processedParagraphs = {};

        var _queryParagraphs = function () {
            var corresponding = [];
            var single = [];
        ...
        var _getParagraph = function (id) {
            return processedParagraphs[id];
        };


        return {
            queryParagraphs: _queryParagraphs,
    ...
    angular
        .module('Jarvis')
        .factory('ParagraphDetectionService', ParagraphDetectionService);
