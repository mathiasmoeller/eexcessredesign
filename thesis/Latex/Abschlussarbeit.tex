...
\pdfinfo{/CreationDate (D:20150620133321)}
...
\begin{center}
	...
	\begin{tabular}{x{6cm}p{7.5cm}}
		...
		\rule{0mm}{5ex}\textbf{Abgabedatum:} & 31.08.2015 \\ 
	\end{tabular} 
\end{center}
\pagebreak
...
\subsection*{Thinking Aloud Test Anweisungen}
\label{eval:instructions}
\includepdf{Evaluation/instructions}

\subsection*{Thinking Aloud Fragebogen}
\label{eval:survey}
\includepdf[pages={1,2}]{Evaluation/survey}
