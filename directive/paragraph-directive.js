(function () {
    ...
    function ParagraphDirective() {
        ...
        return {
            ...
            '<md-button class="md-primary md-raised queryButton" ng-show="showButton" ng-mouseenter="showButton = true" ng-mouseleave="showButton = false" ng-click="query()">' +
            ...
            '</md-button>' +
            '<div  class="detectedParagraph" ng-transclude="true" ng-mouseenter="showButton = true" ng-mouseleave="showButton = false"></div></div>',
